...
func (c *Schema) Update(option options.SubscriberOption) (err error) {
	var bs []byte
...
func (c *Schema) Get(identity string) (option options.SubscriberOption, err error) {
...
func (c *Schema) Lists() (lists []options.SubscriberOption, err error) {
