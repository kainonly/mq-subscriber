...
func init() {
	proto.RegisterType((*NoParameter)(nil), "AMQPSubscriber.NoParameter")
	proto.RegisterType((*Response)(nil), "AMQPSubscriber.Response")
	proto.RegisterType((*Option)(nil), "AMQPSubscriber.Option")
	proto.RegisterType((*PutParameter)(nil), "AMQPSubscriber.PutParameter")
	proto.RegisterType((*DeleteParameter)(nil), "AMQPSubscriber.DeleteParameter")
	proto.RegisterType((*GetParameter)(nil), "AMQPSubscriber.GetParameter")
	proto.RegisterType((*GetResponse)(nil), "AMQPSubscriber.GetResponse")
	proto.RegisterType((*ListsParameter)(nil), "AMQPSubscriber.ListsParameter")
	proto.RegisterType((*ListsResponse)(nil), "AMQPSubscriber.ListsResponse")
	proto.RegisterType((*AllResponse)(nil), "AMQPSubscriber.AllResponse")
}
...
var fileDescriptor_367072455c71aedc = []byte{
	...
	,
}
...
func (c *routerClient) Put(ctx context.Context, in *PutParameter, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/AMQPSubscriber.Router/Put", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) Delete(ctx context.Context, in *DeleteParameter, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/AMQPSubscriber.Router/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) Get(ctx context.Context, in *GetParameter, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/AMQPSubscriber.Router/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) Lists(ctx context.Context, in *ListsParameter, opts ...grpc.CallOption) (*ListsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/AMQPSubscriber.Router/Lists", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) All(ctx context.Context, in *NoParameter, opts ...grpc.CallOption) (*AllResponse, error) {
	out := new(AllResponse)
	err := c.cc.Invoke(ctx, "/AMQPSubscriber.Router/All", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Router_Put_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AMQPSubscriber.Router/Put",
	}
...
func _Router_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AMQPSubscriber.Router/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Router_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AMQPSubscriber.Router/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Router_Lists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AMQPSubscriber.Router/Lists",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Router_All_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AMQPSubscriber.Router/All",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Router_serviceDesc = grpc.ServiceDesc{
	ServiceName: "AMQPSubscriber.Router",
